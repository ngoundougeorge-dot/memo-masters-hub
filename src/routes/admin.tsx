...
const DEFAULT_MOCK_USERS: AdminUser[] = [
  ...
  {
    id: "usr-02",
    full_name: "Dr. Ibrahima Sow",
    email: "ibrahima.sow@redacteur-pro.com",
  ...
  },
  {
    ...
    email: "awa.ndiaye@univ-thies.sn",
  ...
  },
  {
    ...
    email: "fatoumata.b@redaction-master.org",
